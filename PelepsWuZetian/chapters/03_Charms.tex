...
\begin{Charm}{Bellows-Pumping Stride}{%
    ...
    \begin{Unavailable}
        ...
        difficulty 3 and Damage~\Pool[L/round]{\StatVal{Essence}/2}[rounded up]. It burns
...
\begin{Charm}{Confluence of Savant Thought}{%
    Cost=2m,
    Duration=Instant,
    Keywords=Water,
    ...
    water. \tldr{She rolls \Pool{\StatVal{Intelligence} +
    \StatVal{Bureaucracy}} to introduce a fact~\parencite*[p.~237]{ex3}
    about a bureaucratic or mercantile organization that she belongs to or is
    familiar with.}
\end{Charm}
...
\begin{Charm}{Dashing Brook Method}{%
    ...
    bureaucracy, channeling its labor into efficacious speed. \tldr{This Charm
    enhances a project~\parencite*[p.~226]{ex3} or other bureaucratic task,
    multiplying the speed at which the organization makes progress by
    \Pool*{highest of \Options{\StatVal{Charisma}, \StatVal{Manipulation},
    \StatVal{Intelligence}}}.} The Attribute she uses must match her
    leadership style. This Charm cannot speed a bureaucratic task that would
    normally take more than \Pool{\StatVal{Essence}} years.
\end{Charm}
...
\begin{Charm}{Permeating Insight}{%
    ...
    \Pool{\StatVal{Essence}} non-Charm dice on a roll to profile a
...
\begin{Charm}{Scent-of-Crime Method}{%
    ...
    character that has made a Larceny roll in the last \Pool{\StatVal{Essence}} hours.
...
\begin{Charm}{Bloodhound's Nose Technique}{%
    Cost=4m 1wp,
    Duration={\Pool[~days]{\StatVal{Essence}}},
    Keywords=Water/Wood,
    ...
    roll with double 9s to investigate a piece of evidence. The base difficulty of
...
\begin{Charm}{Burning Fury Wreath}{%
    Cost=3m,
    Duration=Instant,
    ...
    \tldr{She ignores \Pool{\StatVal{Strength}/2}[rounded up] points of Hardness, plus
...
\begin{Charm}{Flame-Borne Interception}{%
    ...
    deflects. \tldr{She gains \Modifier{+1} Parry until her next turn. This increases
    by one each time she blocks an attack. This bonus resets if the Dragon-Blood is
    hit by an attack, or defends using an Ability other than Melee.}
\end{Charm}
...
\begin{Charm}{Blinding Spark Distraction}{%
    ...
    turn unless he succeeds on a \Pool{\StatVal{Stamina} +
    \StatVal{Resistance}} roll at a difficulty of
    \Pool{\Val{her \StatVal{Essence}} + \Val{the successes he missed by}}.}
\end{Charm}
...
\begin{Charm}{Crimson Fang Bite}{%
    ...
    \tldr{She adds \Pool*{higher of \Options{\StatVal{Essence}, \StatVal{Strength}}}
    to the raw damage of a \Keyword{withering} attack, or doubles
    \Pool{\StatVal{Strength}} 10s on a \Keyword{decisive} damage roll.}
\end{Charm}
