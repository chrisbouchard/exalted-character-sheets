...
\begin{Charm}{Bellows-Pumping Stride}{%
    ...
    \begin{Unavailable}
        ...
        difficulty 3 and Damage~\Pool[L/round]{\EssenceVal/2}[rounded up]. It burns
...
\begin{Charm}{Confluence of Savant Thought}{%
    ...
    water. \tldr{She rolls \Pool{\AttributeVal{Intelligence} +
    \AbilityVal{Bureaucracy}} to introduce a fact~\parencite*[p.~237]{ex3}
...
\begin{Charm}{Dashing Brook Method}{%
    ...
    \Pool*{highest of \AttributeVal{Charisma}, \AttributeVal{Manipulation},
    or \AttributeVal{Intelligence}}.} The Attribute she uses must match her
    leadership style. This Charm cannot speed a bureaucratic task that would
    normally take more than \Pool{\EssenceVal} years.
\end{Charm}
...
\begin{Charm}{Permeating Insight}{%
    ...
    \Pool{\EssenceVal} non-Charm dice on a roll to profile a
...
\begin{Charm}{Burning Fury Wreath}{%
    ...
    \tldr{She ignores \Pool{\AttributeVal{Strength}/2}[rounded up] points of Hardness, plus
...
\begin{Charm}{Blinding Spark Distraction}{%
    ...
    turn unless he succeeds on a \Pool{\AttributeVal{Stamina} +
    \AbilityVal{Resistance}} roll at a difficulty of
    \Pool{\Val{her \EssenceVal} + \Val{the successes he missed by}}.}
\end{Charm}
...
\begin{Charm}{Crimson Fang Bite}{%
    ...
    \tldr{She adds \Pool*{higher of \EssenceVal{} or \AttributeVal{Strength}}
    to the raw damage of a \Keyword{withering} attack, or doubles
    \Pool{\AttributeVal{Strength}} 10s on a \Keyword{decisive} damage roll.}
\end{Charm}
