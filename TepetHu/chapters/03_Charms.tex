...
\begin{Charm}{Threshold Warding Stance}{%
    ...
    she moves to evade \tldr{She may raise her Evasion for two motes per point,
    or add automatic successes on a Dodge roll for two motes each. She ignores
    environmental penalties to her Evasion or the Dodge roll.}
\end{Charm}
...
\begin{Charm}{Cryptic Essence Cipher}{%
    ...
    code-breaking magic, requires a \Pool{\Options*{\StatVal{Perception},
    \StatVal{Intelligence}} + \StatVal{Linguistics}} roll opposing the
    Dragon-Blood's initial roll.}
...
\begin{Charm}{Secret Wind Revelation}{%
    ...
    \Pool{\StatVal{Occult}} bonus dice opposing its \Pool{\StatVal{Dexterity} +
    \StatVal{Stealth}} roll to pinpoint its location.}
