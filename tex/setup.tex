...
\NewDocumentEnvironment{Merit}{m m m +b}{%
    ...
    \ifdef{\Merit@Keywords}{%
        \\* \textbf{Keywords:} \Merit@Keywords%
    }{}%
    \ifdef{\Merit@Reference}{%
        \\* \textbf{Reference:} \Merit@Reference%
    }{}%
    \par%
    \nopagebreak%
    \par%
...
\NewDocumentCommand{\Artifact}{m}{%
    \setkeys{Artifact}{#1}%
    \textbf{Attunement:} \Artifact@Attunement%
    \\* \textbf{Type:} \Artifact@Type%
    \ifdef{\Artifact@Tags}{%
        \\* \textbf{Tags:} \Artifact@Tags%
    }{}%
    \ifdef{\Artifact@HearthstoneSlots}{%
        \\* \textbf{Hearthstone Slot(s):} \Artifact@HearthstoneSlots%
    }{}%
    \ifdef{\Artifact@Reference}{%
        \\* \textbf{Reference:} \Artifact@Reference%
    }{}%
}
\makeatother
...
\NewDocumentEnvironment{Charm}{m m m +b}{%
    ...
    \def\Charm@Body{%
        ...
        \textbf{Cost:} \Charm@Cost; \textbf{Mins:} \Charm@Mins%
        \\* \textbf{Type:} \Charm@Type%
        \ifdef{\Charm@Keywords}{%
            \\* \textbf{Keywords:} \Charm@Keywords%
        }{}%
        \\* \textbf{Duration:} \Charm@Duration%
        \ifdef{\Charm@Prerequisites}{%
            \\* \textbf{Prerequisite Charms:} \Charm@Prerequisites%
        }{}%
        \ifdef{\Charm@Reference}{%
            \\* \textbf{Reference:} \Charm@Reference%
        }{}%
