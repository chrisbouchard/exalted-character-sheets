...
\begin{Charm}{Solar Excellency}{
    ...
    Solar may spend up to \Pool{\Val{Attribute} + \Val{Ability}} motes, subject
    to the normal limitations on adding dice to a roll with magic
    \parencite*[p.~251]{ex3} \tldr{When using an Excellency to enhance a static
    value, the Solar spends two motes of Essence for every point by which she
    raises the static value,} and may spend up to \Pool{\Val{Attribute} +
    \Val{[Ability that contributes to the static value]}} motes, again, subject
...
\begin{Charm}{Ailment-Rectifying Method}{
    ...
    has properly diagnosed. \tldr{Roll the Exalt’s \Pool{\Val{Intelligence} +
    \Val{Medicine}} against the disease’s morbidity \parencite*[p.~233]{ex3}
    and add half the extra successes to the patient’s Resistance roll at the
    next interval.} Through this Charm, the Solar can weaken or even cure
...
\begin{Charm}{Wound-Mending Care Technique}{
    ...
    \Pool{\Val{Intelligence} + \Val{Medicine}} with double 9s at the end of the
